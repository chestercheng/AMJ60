// Generated by TKG at 2016-12-28 18:26:01
...
const uint8_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    [1] = KEYMAP_TKG(
        ...
        TAB, TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,MPRV,MPLY,MNXT,MUTE,VOLD,VOLU,TRNS, \
        CAPS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,     ENT,  \
        LSFT,     TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,TRNS,FN0, RSFT, \
        LCTL,LALT,LGUI,          TRNS,                    HOME,PGDN,PGUP,END),
